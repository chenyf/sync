...
class UserAddressBooks extends DAV\Collection implements DAV\IExtendedCollection, DAVACL\IACL {
    ...
    private static $defaultProps = array('{DAV:}displayname' => 'Default Address Book');
    ...
    public function getChildren() {
        ...
        $addressbooks = $this->carddavBackend->getAddressbooksForUser($this->principalUri, $this->uid);
        $objs = array();
