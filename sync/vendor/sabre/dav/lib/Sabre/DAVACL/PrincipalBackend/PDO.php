...
class PDO extends AbstractBackend {
    ...
    public function autoCreatePrincipal($uri, $displayname){
        // Grabbing the list of principal id's.
        $stmt = $this->pdo->prepare('INSERT INTO '.$this->tableName.' (uri, displayname) values (?, ?)');
        $stmt->execute(array($uri, $displayname));
    }
